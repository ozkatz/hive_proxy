...
#
# Thrift Service that the MetaStore  is built on (Hive 3.1)
# Taken from:
# https://github.com/apache/hive/blob/branch-3.1/standalone-metastore/src/main/thrift/hive_metastore.thrift
# Modified L396: Map<list<string>, string> is not legal in Go ([]string cannot be a map key).
# Modified L1299, L1280, L1282: isSet* overlaps with Go's code generation convention
#
...
struct WMNullableResourcePlan {
  ...
  5: optional bool queryParallelismIsSet;
  6: optional string defaultPoolPath;
  7: optional bool defaultPoolPathIsSet;
}
...
struct WMNullablePool {
  ...
  4: optional i32 queryParallelism;
  5: optional string schedulingPolicy;
  6: optional bool schedulingPolicyIsSet;
}
